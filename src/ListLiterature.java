    ...
    class ListLiterature {
        ...
        static void defaultAdd(List list) {
            Literature item1 = new Literature("cirstName", "Lev", "tor", 100,2000, 122, "Proza");
            list.add(item1);

            Literature item2 = new Literature("aecondName", "Roma", "zob", 200,1000, 666, "Vobl");
            list.add(item2);

            Literature item3 = new Literature("bhirdName", "Qwerty", "vask", 40,322, 18, "Main");
            list.add(item3);
        }
